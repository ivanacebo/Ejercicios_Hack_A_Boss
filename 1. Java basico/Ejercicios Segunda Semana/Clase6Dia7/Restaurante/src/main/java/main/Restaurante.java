...
public class Restaurante {
    ...
    public static void main(String[] args) {
        ...
        Plato plato1 = new Plato("Pasta Carbonara", "Cocinar la pasta al dente y mezclar con una salsa de huevo, queso parmesano, panceta y pimienta negra", 12.99);
        ...
        Plato plato4 = new Plato("Ensalada César con Pollo", "Mezclar lechuga romana, crutones, queso parmesano y aderezo césar, añadiendo trozos de pollo a la parrilla", 10.75);
